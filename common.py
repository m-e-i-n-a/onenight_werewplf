...
MAP_DICT = {'g1': MAPTILE_GRASS_1, 'g2': MAPTILE_GRASS_2, 'sun':
    ...
    MAPTILE_STAR, 'church': MAPTILE_CHURCH, 'murabito': IMAGE_VILLAGER}
MAP_DATA_NIGHT = [['church', 'church', 'church', 'church', 'church',
    'church', 'church', 'church', 'church', 'church', 'church', 'church',
    'church', 'church', 'church', 'church'], ['church', 'star', '', '', '',
    '', '', '', '', '', '', '', '', '', 'star', 'church'], ['church', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', 'church'], [
    'church', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    'church'], ['church', '', '', '', '', '', '', '', '', '', '', '', '',
    ...
    '', '', '', '', 'church'], ['church', '', '', '', '', '', '', '', '',
    '', '', '', '', '', '', 'church'], ['church', 'star', '', '', '', '',
    '', '', '', '', '', '', '', '', 'star', 'church'], ['church', 'church',
    'church', 'church', 'church', 'church', 'church', 'church', 'church',
    'church', 'church', 'church', 'church', 'church', 'church', 'church'],
    ['church', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    'church'], ['g1', 'g1', 'g1', 'g1', 'g1', 'g1', 'g1', 'g1', 'g1', 'g1',
...
MAP_DATA_DAY = [['church', '', 'church', '', 'church', '', 'church', '',
    ...
    ''], ['church', '', '', '', '', '', '', '', '', '', '', '', '', '', '',
    'church'], ['', '', '', '', '', '', '', '', '', '', '', '', '', '',
    'murabito', ''], ['church', '', 'church', '', 'church', '', 'church',
    '', 'church', '', 'church', '', 'church', '', 'church', ''], ['', '',
    '', '', '', '', '', '', '', '', '', '', '', '', '', ''], ['g2', 'g2',
